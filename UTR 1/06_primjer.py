# Napišite program koji učitava naslov, autora i godinu izdanja knjige, 
# zatim ispisuje poruku: "Knjiga X je napisana od strane Y i izdana je Z"

imeKnjige = input("Unesite ime knjige: ")
