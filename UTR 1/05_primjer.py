# Napišite program koji učitava marku, model i godište automobila, 
# zatim ispisuje poruku: "Automobil je marke X, modela Y i proizveden je Z godine."

markaVozila = input("Unesite marku vašeg vozila: ")
